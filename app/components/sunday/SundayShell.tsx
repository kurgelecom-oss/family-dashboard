...
import FaceRotator from '../face/FaceRotator';
...
export default function SundayShell({preview=false,initialWeekly=false}:{preview?:boolean;initialWeekly?:boolean}){
 ...
 return <>
  ...
  {mode==='weekly'?<SundayReport theme={theme} preview={preview}/>:<div className="dashboard su-daily-dashboard"><GoalsIntermission/><OriginsNudges/><CornerStack/><FaceRotator/></div>}
 </>;
}
