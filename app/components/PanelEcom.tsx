...
export default function PanelEcom() {
  ...
  return (
    <div className="panel col-4" style={{ overflow: "hidden" }}>
      ...
      {/* DAILY WORK TRACKER — top, always visible */}
      <div style={{ flexShrink: 0 }}>
        <div style={{
          fontSize: 10, fontWeight: 700, textTransform: "uppercase",
          letterSpacing: "0.07em", color: "var(--text-muted)", marginBottom: 5,
        }}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 7 }}>
                <div style={{
                  ...
                  fontSize: 9, color: "#000", fontWeight: 800, transition: "all 0.15s ease",
                }}>
                  {saving ? "⏳" : done ? "✓" : null}
                </div>
                <span style={{
